<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderLineList.aspx.cs" Inherits="_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br/>
        <asp:GridView ID="grvOrderLineList" HeaderStyle-BackColor="LightGray" CellPadding="5" CellSpacing="15" HeaderStyle-ForeColor="Black" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="grvOrderLineList_OnSelectedIndexChanged">
            <Columns>
